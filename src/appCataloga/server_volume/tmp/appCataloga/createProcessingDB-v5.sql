...
CREATE TABLE HOST (
	...
	NU_PENDING_METADATA INT COMMENT 'Number of files pending metadata inspection',
    NU_METADATA_ERROR INT COMMENT 'Historic total number of errors in metadata files inspection',
    DT_LAST_METADATA DATETIME COMMENT 'Date and time of the last metadata inspection',
...
CREATE TABLE FILE_TASK_HISTORY (
	...
	DT_PROCESSED DATETIME NOT NULL COMMENT 'Date/time when processing was completed',
