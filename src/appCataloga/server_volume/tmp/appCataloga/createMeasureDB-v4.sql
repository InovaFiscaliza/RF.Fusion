...
CREATE TABLE DIM_SITE_STATE (
    ...
    NA_STATE VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
    LC_STATE VARCHAR(2),
...
CREATE TABLE DIM_SITE_COUNTY (
    ...
    FK_STATE INT,
    NA_COUNTY VARCHAR(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE DIM_SITE_DISTRICT (
    ...
    FK_COUNTY INT,
    NA_DISTRICT VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
