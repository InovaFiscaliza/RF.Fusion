...
CREATE TABLE FILE_LIST (
    ...
    DT_FILE_LAST_ACCESS DATETIME COMMENT 'Date and time of the last file access',
    DT_FILE_LAST_BACKUP DATETIME COMMENT 'Date and time of the last file backup',
