...
CREATE TABLE DIM_SPECTRUN_TRACE_TYPE (
...
CREATE TABLE DIM_SPECTRUN_UNIT (
...
CREATE TABLE DIM_SPECTRUN_PROCEDURE (
...
CREATE TABLE FACT_SPECTRUN (
    ...
    CONSTRAINT FK_DETECTOR_CONSTRAINT FOREIGN KEY (FK_DETECTOR) REFERENCES DIM_SPECTRUN_DETECTOR (ID_DETECTOR),
    CONSTRAINT FK_TRACE_TYPE_CONSTRAINT FOREIGN KEY (FK_TRACE_TYPE) REFERENCES DIM_SPECTRUN_TRACE_TYPE (ID_TRACE_TYPE),
    CONSTRAINT FK_MEASURE_UNIT_CONSTRAINT FOREIGN KEY (FK_MEASURE_UNIT) REFERENCES DIM_SPECTRUN_UNIT (ID_MEASURE_UNIT),
    CONSTRAINT FK_PROCEDURE_CONSTRAINT FOREIGN KEY (FK_PROCEDURE) REFERENCES DIM_SPECTRUN_PROCEDURE (ID_PROCEDURE),
